...
//	NSLog(@"QT-Version: %u",quickTimeVersion & 0xFFFFFF00);
...
//				NSLog(@"TestArray da");
			...
			else
			{
				...
				NSMutableArray* tempTestArray=[[[NSMutableArray alloc]initWithCapacity:0]autorelease];
				NSMutableDictionary* tempTestDic=[[[NSMutableDictionary alloc]initWithCapacity:0]autorelease];
			...
			if ([PListDic objectForKey:@"sessiondatum"])
			{
				...
				int lastJahr=[lastSession yearOfCommonEra];
				int heuteJahr=[heute yearOfCommonEra];
...
//Verschoben in Testpanel 20.12.06
	NSMutableDictionary* returnStatusDic=[[[NSMutableDictionary alloc]initWithCapacity:0]autorelease];
